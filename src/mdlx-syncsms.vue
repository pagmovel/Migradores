<template>
  <a href="#" @click="sincronizar">
    <div class="contenedor" v-bind:class="{ 'expandcontenedor': contenedor, 'aborta': aborta, 'sincronizando':sincronizando}" id="um">
      <i class="fa fa-comments-o vsyncOut" aria-hidden="true" v-show="!aborta" v-bind:class="{ 'vloop': !vsync, 'vsyncOut': vsync }"></i>
...
export default {
  ...
  data () {
    return {
      id: 0,
      titulo: 'Sincronizar Dados do Sms',
    // controle de tela
      liberaBotao: true,
      podeconsultar:true,
      vsync: true,
    ...
    // model
      ...
      aborta:false,
      sincronizando:false,
      src: 'http://localhost/medhospcomunicacao/smsrest/sincronizar{/id}',
      cor: '#643b8a',
      sTime:'',
      countDown:'',
      db:{}
