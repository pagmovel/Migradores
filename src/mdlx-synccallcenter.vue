<template>
      <!-- <div class="col-xs-10 col-xs-offset-5 col-sm-20 col-sm-offset-1 col-md-8 col-md-offset-2"> -->
        <!-- <button class="btn btn-info col-xs-12 col-sm-12 col-md-12 btn-lg" disabled="{{liberaBotao}}" @click="sincronizar">Gerar</button> -->
        <a href="#" @click="sincronizar">
          <div class="contenedor" v-bind:class="{ 'expandcontenedor': contenedor, 'aborta': aborta, 'sincronizando':sincronizando}" id="tres">
            <i class="fa fa-volume-control-phone vsyncOut" aria-hidden="true" v-show="!aborta" v-bind:class="{ 'vloop': !vsync, 'vsyncOut': vsync }"></i>
            <!-- <img class="vsyncOut" v-show="!aborta" v-bind:class="{ 'vloop': !vsync, 'vsyncOut': vsync }" src="<?=base_url('assets/imagens/Sync-Sms-icon.png')?>"> -->
            <i class="fa fa-exclamation-triangle vsyncOut" aria-hidden="true" v-show="aborta" v-bind:class="{ 'vloop': !vsync, 'vsyncOut': vsync }"></i>
            <!-- <img class="vsyncOut" v-show="aborta" v-bind:class="{ 'vloop': !vsync, 'vsyncOut': vsync }" src="<?=base_url('assets/imagens/alert.png')?>"> -->
...
export default {
  data () {
    ...
    // model
      ...
      txtdados:'Call Center',
      aborta:false,
      sincronizando:false,
      src: 'http://localhost/medhospcomunicacao/callcenter/importacron',
      cor: '#643b8a',
      sTime:'',
      countDown:'',
    }
